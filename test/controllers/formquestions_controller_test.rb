...
class FormquestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formquestion" do
    assert_difference('Formquestion.count') do
      post formquestions_url, params: { formquestion: { formbuilder_id: @formquestion.formbuilder_id, question_build: @formquestion.question_build } }
    end
  ...
  test "should update formquestion" do
    patch formquestion_url(@formquestion), params: { formquestion: { formbuilder_id: @formquestion.formbuilder_id, question_build: @formquestion.question_build } }
